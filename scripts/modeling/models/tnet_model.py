...
best_val_acc = -np.inf
best_model_path = "best_temporalNet_weights.pth"
...
for epoch in range(30):
    ...
    if val_acc > best_val_acc:
        ...
        print(f'New best model saved with Val Acc during epoch {epoch}: {best_val_acc:.4f} to {best_model_path}')

# Load best weights
try:
    model.load_state_dict(torch.load(best_model_path))
except Exception as e:
    print("Unable to load best weights")
