...
def entropy(predict: Iterable[int], base: int = 2) -> float:
    """
    Calculates the Shannon Entropy of a Binary Distribution

    Parameters:
        predict (Iterable[int]): Binary sequence in array-like structure.
        base(int, optional): Log base, defaults to 2.

    Returns:
        float: Shannon Entropy of the binary distribution
    """
