...
df2_2 = pd.read_csv('/home/bshi/GaTech Dropbox/Breanna Shi/BioSci-McGrath/PublicIndividualData/Breanna/aim1_final/data_frames/Predict_Manual_Videos_Val/YOLOV5_Cls_Manual_Videos.csv')
...
temp_met = pd.read_csv('/home/bshi/GaTech Dropbox/Breanna Shi/BioSci-McGrath/PublicIndividualData/Breanna/aim1_final/data_frames/track_decision_trees.csv')
temp_fix = temp_met[temp_met.id.isin(list(high_male_entropies.index))]
fix_df2_2 = df2_2[df2_2.id.isin(list(temp_fix.id))]

temp_fix['test1'] = (temp_fix.mean_acceleration <= 0.384) &(temp_fix.distance_traveled <= ) 
