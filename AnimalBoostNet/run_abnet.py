...
parser.add_argument('train_data_path', type=str, help='The filepath to the training dataset to be used.')
...
parser.add_argument('--nworkers', type=int, default=0, help='The number of workers to use in the dataloader (default: 0).')
...
parser.add_argument('--eval_data_path', type=str, help='The filepath to the evaluation dataset to be used (REQUIRED if task is "eval").')
parser.add_argument('--tnet_weights', type=str, default=None, help='The filepath to the TemporalNet weights to use during evaluation (REQUIRED if task is "eval").')
parser.add_argument('--results_path', type=str, default=None, help='The path to be used when saving evaluation results (defaults to None).')
...
# parse arguments and pass to Engine instance
